...
const CollapsableBox = ({ label, children }) => {
  ...
  return (
    <div className="my-4 px-8">
      <div className="border shadow-md rounded-md flex hover:bg-blue-200 p-4 bg-custom-blue items-center justify-between cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
